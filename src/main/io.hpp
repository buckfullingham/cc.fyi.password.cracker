#ifndef PASSWORD_CRACKER_IO_HPP
#define PASSWORD_CRACKER_IO_HPP
...
template <typename Function, typename... Args>
cracker::io::file_descriptor::file_descriptor(Function function, Args... args)
    : value_(posix_call(function, std::forward<Args>(args)...)) {}

template <typename... Args>
cracker::io::memory_map::memory_map(void *ptr, std::size_t len, Args... args)
    : ptr_(posix_call(::mmap, ptr, len, args...)), len_(len) {}

#endif // PASSWORD_CRACKER_IO_HPP
